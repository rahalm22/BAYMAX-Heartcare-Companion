...
while(!feof($myfile)) {  
  $i++; 
  if ($i == 1) $one = number_format((float)fgets($myfile),2,'.','');
  else if ($i == 2) $two = number_format((float)fgets($myfile),2,'.','');
  else if ($i == 3) $three = number_format((float)fgets($myfile),2,'.','');
  else if ($i == 4) $four = number_format((float)fgets($myfile),2,'.','');
  else if ($i == 5) $five = number_format((float)fgets($myfile),2,'.','');
  else if ($i == 6) $six = number_format((float)fgets($myfile),2,'.','');
  else if ($i == 7) $seven = number_format((float)fgets($myfile),2,'.','');
  else fgets($myfile);
}
$oneint = (int)$one;
$twoint = (int)$two;
...
<div class="w3-overlay w3-hide-large" onclick="w3_close()" style="cursor:pointer" title="close side menu" id="myOverlay"></div>
    ...
    <!--First parallax image with Logo text --> 
      <div class="fadeIn animated" style="white-space:nowrap; margin-left: 400px; margin-top: 100px">
        <h2> Here is our prediction </h2><br><br>
      
          <p >Cardio Vascular Disease</p>
          <div class="w3-grey">
            <div class="w3-container w3-padding-small w3-red w3-center" style="width:<?php echo $oneint ?>%"><?php echo $one ?>%</div>
          </div>
          <p >Congestive Heart Failure</p>
          <div class="w3-grey">
            <div class="w3-container w3-padding-small w3-red w3-center" style="width:<?php echo $twoint ?>%"><?php echo $two ?>%</div>
          </div>
          <p >Coronary Heart Disease</p>
          <div class="w3-grey">
            <div class="w3-container w3-padding-small w3-red w3-center" style="width:<?php echo $threeint ?>%"><?php echo $three ?>%</div>
          </div>
          <p >Hard Coronary Heart Disease</p>
          <div class="w3-grey">
            <div class="w3-container w3-padding-small w3-red w3-center" style="width:<?php echo $fourint ?>%"><?php echo $four ?>%</div>
          </div>
          <p >Intermittent Claudication</p>
          <div class="w3-grey">
            <div class="w3-container w3-padding-small w3-red w3-center" style="width:<?php echo $fiveint ?>%"><?php echo $five ?>%</div>
          </div>
          <p >Stroke</p>
          <div class="w3-grey">
            <div class="w3-container w3-padding-small w3-red w3-center" style="width:<?php echo $sixint ?>%"><?php echo $six ?>%</div>
          </div>
          <p >Artial Fibrillation</p>
          <div class="w3-grey">
            <div class="w3-container w3-padding-small w3-red w3-center" style="width:<?php echo $sevenint ?>%"><?php echo $seven ?>%</div>
          </div>
          <br><br>
      </div>
